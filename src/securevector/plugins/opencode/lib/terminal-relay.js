...
// Optional bridge used only for OpenCode sessions launched by Agent Terminals.
...
// ESM, matching the rest of the OpenCode plugin (package.json type: module).

export async function postTerminalEvent(event) {
...
export default { postTerminalEvent };
