...
"statusLine": {
  "type": "command",
  "command": "node ~/.claude/plugins/cache/securevector-local/securevector-guard/4.4.0/hooks/statusline.js",
  "refreshInterval": 5
}
```
...
sv = subprocess.run(
    ["node", "/Users/me/.claude/plugins/cache/securevector-local/securevector-guard/4.4.0/hooks/statusline.js"],
