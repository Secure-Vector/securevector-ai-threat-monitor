...
Size limits enforced before any POST: `args_preview` capped at 8 KB (8192 characters) after redaction, and the app redacts and caps it again before storing; `/analyze` `text` capped at 8 KB for prompt/prose scans and 16 KB for tool-response scans.
