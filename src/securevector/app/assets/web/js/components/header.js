...
graph.add_edge("output_security", END)`,
    ...
    PAGE_INFO: {
        ...
        terminals:         { title: 'Agent Sessions',         subtitle: 'Launch or return to governed harness work, with verdicts and approvals beside it' },
        ...
        'proxy-python':    { title: 'Python @guard',       subtitle: 'One decorator for tool calls, one call for model calls: tokens, cost and verdicts per run' },
        ...
        'proxy-claude-code': { title: 'Claude Code',       subtitle: 'Claude Code plugin: real-time policy enforcement and tamper-evident audit for MCP tool calls' },
        'proxy-codex':     { title: 'Codex',               subtitle: 'OpenAI Codex CLI plugin: real-time policy enforcement and tamper-evident audit for MCP tool calls' },
        'proxy-copilot-cli': { title: 'GitHub Copilot CLI', subtitle: 'Copilot CLI plugin: real-time policy enforcement and tamper-evident audit for tool calls' },
        'proxy-cursor':    { title: 'Cursor',              subtitle: 'Cursor IDE agent: real-time policy enforcement and tamper-evident audit for shell, MCP, file edits, and prompts' },
        'proxy-opencode':  { title: 'OpenCode',            subtitle: 'OpenCode plugin: real-time policy enforcement and tamper-evident audit for built-in and MCP tool calls' },
        'proxy-antigravity': { title: 'Antigravity',       subtitle: 'Antigravity plugin: real-time policy enforcement and tamper-evident audit for built-in and MCP tool calls' },
        'proxy-node':      { title: 'Node and TypeScript', subtitle: 'JavaScript agents: a verdict on every tool call, model runs in Traces, and identity on every row' },
        'guide-claude-code': { title: 'Claude Code Plugin', subtitle: 'Integration guide: install, verify, and enforce policy in Claude Code' },
        'guide-codex':     { title: 'Codex Plugin',        subtitle: 'Integration guide: install, verify, and enforce policy in Codex' },
        'guide-copilot-cli': { title: 'GitHub Copilot CLI Plugin', subtitle: 'Integration guide: install, verify, and enforce policy in Copilot CLI' },
        'guide-cursor':    { title: 'Cursor Plugin',       subtitle: 'Integration guide: install, verify, and enforce policy in Cursor' },
        'guide-opencode':  { title: 'OpenCode Plugin',     subtitle: 'Integration guide: install, verify, and enforce policy in OpenCode' },
        'guide-antigravity': { title: 'Antigravity Plugin', subtitle: 'Integration guide: install, verify, and enforce policy in Antigravity' },
        'guide-openclaw':  { title: 'OpenClaw / ClawdBot Plugin', subtitle: 'Integration guide: install, verify, and enforce policy in OpenClaw' },
        'guide-frameworks': { title: 'Framework SDKs',     subtitle: 'LangChain, LangGraph, CrewAI, and Hermes SDK setup for agent protection' },
    },
