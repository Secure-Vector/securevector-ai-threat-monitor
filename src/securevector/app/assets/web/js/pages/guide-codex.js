...
const GuideCodexPage = {
    async render(container) {
        ...
        root.appendChild(p('All hooks fail-open: any error path behaves like "allow" and the plugin never breaks a Codex session. All HTTP targets the local app on loopback at http://127.0.0.1:8741 (override with SECUREVECTOR_URL).'));
        ...
        root.appendChild(p('3. Visit http://127.0.0.1:8741 → Agent Activity. Your Codex run appears on the Agent Map, in Runs, and on the Timeline.'));
