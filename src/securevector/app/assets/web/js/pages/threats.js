    ...
    renderContent(container) {
        ...
        const threatsDt = new DataTable({
            columns: [
                ...
                { key: null, label: 'Actions', render: (_, threat) => {
                    const wrap = document.createDocumentFragment();
                    ...
                    btn.className = 'btn btn-small btn-icon'; btn.textContent = '\u{1F441}'; btn.title = 'View details';
                    btn.addEventListener('click', (e) => { e.stopPropagation(); self.showThreatDetails(threat); });
