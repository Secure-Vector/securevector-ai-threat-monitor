...
from .threat_types import ThreatType, RiskLevel
...
class PolicyRule:
    ...
    def evaluate(self, risk_score: int, threat_types: List[str], 
                 confidence: float, prompt: str = "") -> bool:
...
class SecurityPolicy:
    ...
    def evaluate(self, risk_score: int, threat_types: List[str], 
                 confidence: float, prompt: str = "") -> PolicyAction:
    ...
    def create_strict_policy(cls) -> 'SecurityPolicy':
        ...
        for threat_type in [ThreatType.PROMPT_INJECTION, ThreatType.DATA_EXFILTRATION,
                           ThreatType.JAILBREAK, ThreatType.SOCIAL_ENGINEERING,
