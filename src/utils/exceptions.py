...
from ai_threat_monitor.models.policy_models import PolicyAction
...
class ErrorSolution:
    ...
    def __init__(self, code: ErrorCode, title: str, description: str, 
                 solutions: List[str], docs_url: Optional[str] = None):
        self.code = code
        self.title = title
...
class ModeNotAvailableError(AIThreatMonitorException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.MODE_NOT_AVAILABLE, **kwargs):
        super().__init__(message, error_code, kwargs)
...
class APIError(AIThreatMonitorException):
    ...
    def __init__(self, message: str, status_code: Optional[int] = None, 
                 ...
                 error_code: ErrorCode = ErrorCode.API_CONNECTION_FAILED, **kwargs):
        context = {
...
class ValidationError(AIThreatMonitorException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.VALIDATION_INVALID_INPUT_TYPE, **kwargs):
        super().__init__(message, error_code, kwargs)
...
class CacheError(AIThreatMonitorException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.CACHE_WRITE_FAILED, **kwargs):
        super().__init__(message, error_code, kwargs)
...
class PerformanceError(AIThreatMonitorException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.PERFORMANCE_THRESHOLD_EXCEEDED, **kwargs):
        super().__init__(message, error_code, kwargs)
...
class CircuitBreakerError(AIThreatMonitorException):
    ...
    def __init__(self, message: str, error_code: ErrorCode = ErrorCode.CIRCUIT_BREAKER_OPEN, **kwargs):
        super().__init__(message, error_code, kwargs)
