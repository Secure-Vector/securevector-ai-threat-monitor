...
from ai_threat_monitor.models.config_models import LocalModeConfig, APIModeConfig, HybridModeConfig
from ai_threat_monitor.models.analysis_result import AnalysisResult, ThreatDetection, DetectionMethod
from utils.logger import get_logger
from utils.performance import PerformanceTracker, ContextTimer
...
class HybridMode:
    ...
    def __init__(self, local_config: LocalModeConfig, api_config: APIModeConfig, 
        ...
        self.router = SmartRouter(hybrid_config, self.performance) if hybrid_config.smart_routing else None
    ...
    def _should_use_api(self, local_result: AnalysisResult, prompt: str, **kwargs) -> bool:
        ...
        if self.hybrid_config.local_first:
            ...
            return (
                local_result.risk_score >= self.hybrid_config.api_threshold_score or
    ...
    def _combine_results(self, local_result: AnalysisResult, api_result: AnalysisResult, 
    ...
    def get_health_status(self) -> Dict[str, Any]:
        ...
        status = {
            ...
            "api_mode_status": self.api_mode.get_health_status() if self.api_mode else {"available": False},
        ...
        api_healthy = status["api_mode_status"].get("status") == "healthy" if self.api_mode else True
    ...
    def update_config(self, local_config: Optional[LocalModeConfig] = None,
                     api_config: Optional[APIModeConfig] = None,
                     hybrid_config: Optional[HybridModeConfig] = None) -> None:
