...
class APIAnalyzer:
    ...
    def _parse_success_response(self, response: requests.Response, start_time: float) -> AnalysisResult:
    ...
    def _parse_batch_response(self, response: requests.Response, start_time: float) -> List[AnalysisResult]:
