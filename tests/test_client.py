...
class TestSecureVectorClient:
    ...
    def test_client_initialization_hybrid_mode(self, mock_api_key):
        ...
        client = SecureVectorClient(mode=OperationMode.HYBRID, api_key=mock_api_key)
        assert client is not None
    ...
    def test_client_initialization_api_mode(self, mock_api_key):
        ...
        client = SecureVectorClient(mode=OperationMode.API, api_key=mock_api_key)
        assert client is not None
    ...
    def test_client_configuration_validation(self, client_config):
        ...
        client = SecureVectorClient(mode=OperationMode.LOCAL, **client_config)
        assert client is not None
