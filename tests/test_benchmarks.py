...
class TestPerformanceBenchmarks:
    ...
    def test_batch_processing_performance(self, sample_prompts):
        ...
        with patch.object(client, 'analyze_batch') as mock_analyze_batch:
            ...
            assert avg_time_per_item < 50, f"Average time per item {avg_time_per_item:.1f}ms exceeds 50ms threshold"
    ...
    def test_memory_usage_reasonable(self, sample_prompts):
        ...
        with patch.object(client, 'analyze') as mock_analyze:
            ...
            assert memory_increase < 100, f"Memory increased by {memory_increase:.1f}MB, which exceeds 100MB threshold"
    ...
    def test_concurrent_processing(self, sample_prompts):
        ...
        with patch.object(client, 'analyze') as mock_analyze:
            ...
            assert total_time < 500, f"Concurrent processing took {total_time:.1f}ms, exceeds 500ms threshold"
